...
export const APP_DESCRIPTION = 'Démonstration complète d\'un système d\'authentification Next.js avec authentification à deux facteurs (A2F) par email'
...
export const ENV = {
  ...
  // 2FA configuration
  TWOFA_CODE_EXPIRY_MINUTES: parseInt(process.env.TWOFA_CODE_EXPIRY_MINUTES || '5'),
